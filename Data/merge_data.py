...
def error():
    lawn1 = pd.read_excel('../Test/Results1/Error/ErrorLawnmower.xlsx')
    lawn = lawn1.to_numpy()
    lawn = lawn[:, 1]
    ...
    # epsilon = epsilon[:, 1]
    aqua1 = pd.read_excel('../Test/Results2/Error/ErrorAquaHet.xlsx')
    aqua = aqua1.to_numpy()
    aqua = aqua[:, 1]
...
def mseaz():
    lawn1 = pd.read_excel('../Test/Results1/MSEAZ/MSEAZLawnmower.xlsx')
    lawn = lawn1.to_numpy()
    # lawn = lawn[:, 1]
    ...
    # epsilon = epsilon1.to_numpy()
    # epsilon = epsilon[:, 1]
    aqua1 = pd.read_excel('../Test/Results2/MSEAZ/MSEAZAquaHet.xlsx')
    aqua = aqua1.to_numpy()
    aqua = aqua[:, 1]
    return aqua1, lawn1#, way1, grid1, bo1, cpso1, explore1, exploit1, epsilon1
...
def msem():
    lawn1= pd.read_excel('../Test/Results1/MSEM/MSEMLawnmower.xlsx')
    lawn = lawn1.to_numpy()
    lawn = lawn[:, 1]
    ...
    # epsilon = epsilon1.to_numpy()
    # epsilon = epsilon[:, 1]
    aqua1 = pd.read_excel('../Test/Results2/MSEM/MSEMAquaHet.xlsx')
    aqua = aqua1.to_numpy()
    aqua = aqua[:, 1]
    return aqua1, lawn1#, way1, grid1, bo1, cpso1, explore1, exploit1, epsilon1

def r2m():
    lawn1= pd.read_excel('../Test/Results1/R2M/R2MLawnmower.xlsx')
    lawn = lawn1.to_numpy()
    lawn = lawn[:, 1]
    ...
    # epsilon = epsilon1.to_numpy()
    # epsilon = epsilon[:, 1]
    aqua1 = pd.read_excel('../Test/Results2/R2M/R2MAquaHet.xlsx')
    aqua = aqua1.to_numpy()
    aqua = aqua[:, 1]
    return aqua1, lawn1#, way1, grid1, bo1, cpso1, explore1, exploit1, epsilon1
