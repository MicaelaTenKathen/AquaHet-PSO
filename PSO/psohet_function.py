...
class PSOEnvironment(gym.Env):
    ...
    def data_out(self):
        ...
        df1.to_excel('../Test/Results/Error/ErrorAquaHet.xlsx')
        df2 = pd.DataFrame(self.mean_az_mse)
        df2.to_excel('../Test/Results/MSEAZ/MSEAZAquaHet.xlsx')
        df3 = pd.DataFrame(self.mean_mse_error)
        df3.to_excel('../Test/Results/MSEM/MSEMAquaHet.xlsx')
        df4 = pd.DataFrame(self.mean_error)
        df4.to_excel('../Test/Results/R2M/R2MAquaHet.xlsx')
